...
雷达图(0-100)：wenqing=文青浓度(大众爆款↔小众到没朋友), emo=emo指数(嗨歌喜剧↔深夜emo循环), shekong=社恐值(社交话题↔品味孤独), kaogu=考古癖(只追新↔活在上世纪), shangtou=上头度(浅尝辄止↔入坑就疯), chouxiang=抽象浓度(正常审美↔精神状态令人担忧/发疯文学审美)
